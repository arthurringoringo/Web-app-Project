        ...
        <div class="container-fluid  ">
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Add new Contact / Customer infromation and details.</p>
                            <a href="addcontact.php" class="btn btn-primary">Add New Contact</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row pt-2">
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">View all Contact</h5>
                            <p class="card-text">View all contacts that exist.</p>
                            <a href="viewcontact.php" class="btn btn-primary">View Contact</a>
                        </div>
                    </div>
                </div>
