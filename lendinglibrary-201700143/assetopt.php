        ...
        <div class="container-fluid  ">
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text">Add new Asset infromation and details.</p>
                            <a href="addasset.php" class="btn btn-primary">Add New Asset</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">View Asset Lending History</h5>
                            <p class="card-text">View Asset and current lender of Asset</p>
                            <a href="assetlendinghist.php" class="btn btn-primary">View Asset</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row pt-2">
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">View all Asset</h5>
                            <p class="card-text">View all Asset that exist.</p>
