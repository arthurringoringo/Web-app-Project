    ...
    <div id="page-content-wrapper">
        ...
        <div class="container-fluid mt-4 justify-content-center ">
            ...
            if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                require('processes/out-process.php');
            }
            ?>
            <form action="checkout.php" id="regform" method="POST" name="regform"  enctype="multipart/form-data" onsubmit="return checked();">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-5 sm-5 ">
                        <select class="form-control " required id="id" name="id">
                            ...
                            $sql = "SELECT ID_number,Item FROM Assets WHERE Status = 'Available'";
                ...
                <div class="form-group row">
                    <label for="condition" class="col-sm-1 col-form-label">Check out Condition:</label>
                    <div class="col-5 sm-5 ">
                ...
                <div class="form-group row">
                    <label for="checkto" class="col-sm-1 col-form-label">Check out To:</label>
                    <div class="col-5 sm-5 ">
                        <select class="form-control "  required id="checkto" name="checkto">
                            <option value=""><-- Please Select Item --></option>
                            <?php
                            require ('includes/db.inc.php');
                ...
                <div class="form-group row">
                    ...
                    <div class="col-5 sm-5 " >
                        <input id="duedate"  placeholder="Due Date" maxlength="40" name="duedate" value="<?php if (isset($_POST['duedate']))  echo $_POST['duedate'];  ?>">
                    </div>
                    <script>
                        $('#duedate').datepicker({
                ...
                <div class="form-group row">
                    <div class="col-auto my-1">
                        <button type="submit" name="submit" value="submit" class="btn btn-primary">Check Out</button>
                    </div>
